...
class Player2():
	def __init__(self, x, y):
		self.x = x 
		self.y = y
		# isJump and jumpCount should be attributes.			ainda nao é
		self.isJump = False
		self.jumpCount = 10
...
while run:                                				# While de INICIO, vai até ao fim
	clock.tick(FPS)	
	obstacle_state = obstacle1_speed
	scroll_state = scroll1
				 						# impoe a limitação de FPS do programa usando o clock. já definido acima
